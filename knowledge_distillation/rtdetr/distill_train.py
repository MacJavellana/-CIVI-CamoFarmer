...
"""
RT-DETR Knowledge Distillation Trainer
-------------------------------------
Custom RT-DETR trainer implementing feature-based distillation for efficient detection.

Functions

- **RTDETRDistillationTrainer:** Extended RT-DETR trainer with teacher-student learning.
- **criterion:** Combined detection and distillation loss computation.
- **_compute_distillation_loss:** Feature-level knowledge transfer loss.
----
"""
...
class RTDETRDistillationTrainer(RTDETRTrainer):
    """Extended RT-DETR Trainer with Knowledge Distillation.
    
    Implements teacher-student training with feature alignment for RT-DETR models.
    """
    
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        """Initialize RT-DETR Distillation Trainer.

        Args:
            cfg: Training configuration. Default: DEFAULT_CFG.
            overrides (dict): Configuration overrides including distillation parameters.
            _callbacks: Training callbacks.
        """
    ...
    def criterion(self, preds, batch):
        ...
        Returns:
            tuple: (combined_loss, loss_items) with detection + distillation losses.
        """
